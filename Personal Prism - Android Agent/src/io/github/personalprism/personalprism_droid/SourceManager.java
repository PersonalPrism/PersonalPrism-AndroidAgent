...
/**
 * The Class SourceManager. UNUSED IN CS PROJECT. This is supposed to handle the
 * data sources - configuration and initialization. It will be wired up to an
 * alarm to make sure settings are correct and send poll triggers to things that
 * need polled(we wouldn't want to have bunches of data sources that all have
