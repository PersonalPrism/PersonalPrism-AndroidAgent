...
// Toast.makeText(this, debug, Toast.LENGTH_LONG).show();
    ...
    private void searchLocationHelper(Intent intent)
    {
        ...
        Predicate<Location> predicate =
            (Predicate<Location>)SerializationUtils.deserialize(intent
                .getByteArrayExtra(DBHANDLER_LOCATION_QUERY));
        QueryComparator<Location> comparator =
            (QueryComparator<Location>)SerializationUtils.deserialize(intent
